...
public class CreateMenuActivity extends AppCompatActivity {
    ...
    private void submitMenu() {
        radio = findViewById(R.id.radio_group_id);
        int radiocheckedid = radio.getCheckedRadioButtonId();
        String type;
        if(radiocheckedid == R.id.nonveg_id){
            type = "NonVeg";
        }
        else{
            type = "Veg";
        ...
        Menu menu = new Menu(menuName, menuRate, menuItems,type);
